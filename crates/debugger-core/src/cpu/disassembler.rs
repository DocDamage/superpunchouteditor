...
fn decode_instruction_at(
    ...
    let operands = if operand_size > 0 {
        ...
        def.addressing_mode
            .format_operands(operand_bytes, pc, is_8bit_accumulator, is_8bit_index)
    } else {
        String::new()
    };
...
fn get_instruction_def(opcode: u8) -> Option<InstructionDef> {
    Some(match opcode {
        ...
        0xB5 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectX,
            cycles: 4,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xA1 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectIndirectX,
            cycles: 6,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xB1 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectIndirectY,
            cycles: 5,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xB2 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectIndirect,
            cycles: 5,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xA7 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectIndirectLong,
            cycles: 6,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xB7 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::DirectIndirectLongY,
            cycles: 6,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xBF => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::AbsoluteLongX,
            cycles: 5,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xA3 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::StackRelative,
            cycles: 4,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xB3 => InstructionDef {
            opcode,
            mnemonic: "LDA",
            addressing_mode: AddressingMode::StackRelativeIndirectY,
            cycles: 7,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xA2 => InstructionDef {
            opcode,
            mnemonic: "LDX",
            addressing_mode: AddressingMode::Immediate16,
            cycles: 2,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0xB6 => InstructionDef {
            opcode,
            mnemonic: "LDX",
            addressing_mode: AddressingMode::DirectY,
            cycles: 4,
            is_branch: false,
            is_call: false,
            is_return: false,
        ...
        0x6C => InstructionDef {
            opcode,
            mnemonic: "JMP",
            addressing_mode: AddressingMode::AbsoluteIndirect,
            cycles: 5,
            is_branch: true,
            is_call: false,
            is_return: false,
        ...
        0xDC => InstructionDef {
            opcode,
            mnemonic: "JML",
            addressing_mode: AddressingMode::AbsoluteIndirectLong,
            cycles: 6,
            is_branch: true,
            is_call: false,
            is_return: false,
        ...
        0x82 => InstructionDef {
            opcode,
            mnemonic: "BRL",
            addressing_mode: AddressingMode::RelativeLong,
            cycles: 4,
            is_branch: true,
            is_call: false,
            is_return: false,
        ...
        0x54 => InstructionDef {
            opcode,
            mnemonic: "MVN",
            addressing_mode: AddressingMode::BlockMove,
            cycles: 7,
            is_branch: false,
            is_call: false,
            is_return: false,
